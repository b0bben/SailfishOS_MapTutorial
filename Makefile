...
Makefile: MapTutorial.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/MapTutorial1.0.0 || mkdir -p obj/MapTutorial1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/MapTutorial1.0.0/ && $(COPY_FILE) --parents src/MapTutorial.cpp obj/MapTutorial1.0.0/ && (cd `dirname obj/MapTutorial1.0.0` && $(TAR) MapTutorial1.0.0.tar MapTutorial1.0.0 && $(COMPRESS) MapTutorial1.0.0.tar) && $(MOVE) `dirname obj/MapTutorial1.0.0`/MapTutorial1.0.0.tar.gz . && $(DEL_FILE) -r obj/MapTutorial1.0.0
...
obj/MapTutorial.o: src/MapTutorial.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/MapTutorial.o src/MapTutorial.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/MapTutorial || mkdir -p $(INSTALL_ROOT)/usr/share/MapTutorial
	-$(INSTALL_DIR) /home/mersdk/dev/temp/MapTutorial/qml $(INSTALL_ROOT)/usr/share/MapTutorial/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/MapTutorial/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/MapTutorial/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/dev/temp/MapTutorial/MapTutorial.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/MapTutorial.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/dev/temp/MapTutorial/MapTutorial.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/MapTutorial.png
